   ...
   return  Column(
     ...
     children: [
       Container(
         ...
         child:  Padding(
           padding: nkRegularPadding(top: AppSizes.height_2,left: AppSizes.width_4,right: AppSizes.width_4),
           child:  Column(
             crossAxisAlignment: CrossAxisAlignment.start,
             children: [
                Row(
                  ...
                  children: [
                    MyRegularText(label: companyName??'',color: Colors.white,fontWeight: FontWeight.w600,),
               Padding(
               ...
               Padding(
                 ...
                 child: Row(children: [
                   SvgPicture.asset('assets/icons/box.svg',color: Colors.white,),
                   SizedBox(width: AppSizes.width_2,),
                    MyRegularText(label: machineName??'',color: Colors.white,fontWeight: FontWeight.w500,),],),
               ),
               const Divider(color: dividerColour,),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Row(
                     children: [
                      const MyRegularText(label: 'Make',color: Colors.white,fontWeight: FontWeight.w500,fontSize: 10),
                       const Padding(
                         padding: EdgeInsets.only(left: 4,right: 4),
                         child: MyRegularText(label: ':',color: Colors.white,fontWeight: FontWeight.w500,fontSize: 10),
                       ),
                       MyRegularText(label: make??'',fontWeight: FontWeight.w500,color: Colors.white,fontSize: 10)
                     ],
               ),
               Row(
                     children: [
                       const MyRegularText(label: 'Model',color: Colors.white,fontWeight: FontWeight.w500,fontSize: 10,),
                       const Padding(
                         padding: EdgeInsets.only(left: 4,right: 4),
                         child: MyRegularText(label: ':',color: Colors.white,fontWeight: FontWeight.w500,fontSize: 10),
                       ),
                       MyRegularText(label: model??'',fontWeight: FontWeight.w500,color: Colors.white,fontSize: 10)
                     ],
               ),
               Row(
                     children: [
                       ...
                       MyRegularText(label: serial??'',fontWeight: FontWeight.w500,color: Colors.white,fontSize: 10)
                     ],
               ),
                  ],
                ),
